...
authRoute.post('/login', async (c) => {
    try {
        ...
        const payload = {
            ...validation.data,
            role: "" as "candidate" | "hr" | "developer"
        }
        ...
        if (error instanceof GetUserByEmailFromDBError || error instanceof AddUserInDBError || error instanceof GetCandidateByEmailFromDBError || error instanceof AddCandidateInDBError || error instanceof GetHRByEmailFromDBError || error instanceof LoginUserError) {
